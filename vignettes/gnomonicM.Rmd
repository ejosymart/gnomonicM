...
You can display the plots showing the M values in day o year units. By default the units of M is in days (`dayUnits = 'TRUE'`). You can modify it via the argument `dayUnits = 'FALSE'`, which will show a plot with the M values in years. 
