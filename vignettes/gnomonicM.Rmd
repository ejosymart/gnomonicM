...
In the previous plots, by default, the M values have $day^-1$ units. You can modify it via the argument `dayUnits = FALSE` which will show a plot with the M values in $year^-1$ units.
